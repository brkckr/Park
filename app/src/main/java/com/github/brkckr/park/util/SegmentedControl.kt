...
/*
* Control from https://github.com/zach-klippenstein
*
* Control -> https://gist.github.com/zach-klippenstein/7ae8874db304f957d6bb91263e292117#file-_segmentedcontrol-kt
*
* License -> https://gist.github.com/zach-klippenstein/7ae8874db304f957d6bb91263e292117#file-license
* */
...
private val TRACK_COLOR = Color.Black.copy(alpha = .7f)
...
private const val PRESSED_UNSELECTED_ALPHA = .8f
...
fun SegmentText(text: String) {
    Text(text, color = Color.LightGray, maxLines = 1, overflow = TextOverflow.Ellipsis)
}
...
private fun Thumb(state: SegmentedControlState) {
    Box(
        Modifier
            ...
            .background(MaterialTheme.colors.secondary, BACKGROUND_SHAPE)
    )
}
 ...
 *
 * line color transparent means no divider.
 */
@Composable
